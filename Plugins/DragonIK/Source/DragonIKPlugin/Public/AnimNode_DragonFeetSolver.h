...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BasicSettings, meta = (DisplayName = "Location Interpolation Type"))
		EInterpoLocation_Type_Plugin loc_interp_type = EInterpoLocation_Type_Plugin::ENUM_DivisiveLoc_Interp;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BasicSettings, meta = (DisplayName = "Rotation Interpolation Type"))
		EInterpoRotation_Type_Plugin rot_interp_type = EInterpoRotation_Type_Plugin::ENUM_DivisiveRot_Interp;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Feet Rotation Interpolation Speed", PinHiddenByDefault))
	...
	bool Check_Loop_Exist(FVector Feet_Trace_Offset,FVector knee_direction_offset,float feet_rotation_limit,FRotator feet_rotation_offset,float feet_height, FName start_bone, FName knee_bone, FName thigh_bone, FName input_bone, TArray<FName> total_spine_bones);
...
//		float line_trace_height = 1000;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedSettings, meta = (DisplayName = "Ignore Rotation Lerping"))
		bool Ignore_Lerping = true;


	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedSettings, meta = (DisplayName = "Ignore Location Lerping"))
		bool Ignore_Location_Lerping = true;
...
//	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Automatic Foot Height Detection", PinHiddenByDefault))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Feet Position Interpolation Speed", PinHiddenByDefault))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Character Direction Vector", PinHiddenByDefault))
