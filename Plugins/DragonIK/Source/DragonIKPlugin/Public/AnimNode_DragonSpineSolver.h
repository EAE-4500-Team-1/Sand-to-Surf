...
//		mutable float Vertical_Solver_Upper_Scale = 1;
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedSettings, meta = (DisplayName = "Extra Dip Multiplier"))
		float dip_multiplier = 0;




	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedSettings, meta = (DisplayName = "Rotate and move bone around terrain ? (Disabling gives more stable but slightly inaccurate solving)"))
		bool Rotate_Around_Translate = true;



	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedSettings, meta = (DisplayName = "Ignore Lerping"))
...
//	TArray<FDragonData_SpineFeetPair_heights> Total_spine_heights;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = BasicSettings, meta = (DisplayName = "Minimum Terrain-Capsule Activation Distance", PinHiddenByDefault))
		float Minimum_Feet_Distance = 15;
